...
public class Numbers {
	 ...
	 *
	 * Use any databases[ Oracle or MySql] to store data and retrieve data.
	 *
	...
	public static void main(String[] args) throws Exception {
		...
		connectToSqlDB.insertDataFromArrayToSqlTable(num, "Insertion_sort", "SortingNumbers");
		 connectToSqlDB.readDataBase("Insertion_sort", "SortingNumbers");
		printValue(numbers);
		randomize (num, n);
		...
		connectToSqlDB.insertDataFromArrayToSqlTable(num, "Bubble_sort", "SortingNumbers");
		 connectToSqlDB.readDataBase("Bubble_sort", "SortingNumbers");
		printValue(numbers);
		randomize (num, n);
		...
		connectToSqlDB.readDataBase("Merge_sort", "SortingNumbers");
		printValue(numbers);
		randomize (num, n);

		//Quick Sort

		algo.quickSort(num,10,10);
		...
		connectToSqlDB.readDataBase("quick_sort", "SortingNumbers");
		printValue(numbers);
		randomize (num, n);
		...
		connectToSqlDB.readDataBase("Heap_sort", "SortingNumbers");
		printValue(numbers);
		randomize (num, n);
